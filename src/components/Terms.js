...
const Terms = () => {
	return (
		<Page title="Terms">
			...
			<p>Welcome to Speak Out!</p>

			<p>These terms and conditions outline the rules and regulations for the use of Speak Out's Website.</p>

			<p>
				By accessing this website we assume you accept these terms and conditions. Do not continue to use Speak Out if
			...
			<p>
				We employ the use of cookies. By accessing Speak Out, you agreed to use cookies in agreement with the Speak
			...
			<p>
				Unless otherwise stated, Speak Out and/or its licensors own the intellectual property rights for all material on
				Speak Out. All intellectual property rights are reserved. You may access this from Speak Out for your own
				personal use subjected to restrictions set in these terms and conditions.
			</p>

			<p>You must not:</p>
			<ul>
				<li>Republish material from Speak Out</li>
				<li>Sell, rent or sub-license material from Speak Out</li>
				<li>Reproduce, duplicate or copy material from Speak Out</li>
				<li>Redistribute content from Speak Out</li>
			</ul>
			...
			<p>
				...
				areas of the website. Speak Out does not filter, edit, publish or review Comments prior to their presence on the
				website. Comments do not reflect the views and opinions of Speak Out,its agents and/or affiliates. Comments
				reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
				applicable laws, Speak Out shall not be liable for the Comments or for any liability, damages or expenses caused
				and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
			</p>

			<p>
				Speak Out reserves the right to monitor all Comments and to remove any Comments which can be considered
			...
			<p>
				You hereby grant Speak Out a non-exclusive license to use, reproduce, edit and authorize others to use,
